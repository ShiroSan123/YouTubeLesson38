...
<body>
	...
	<?php 
	    ...
	    $query = mysqli_query($con, "SELECT * FROM videos INNER JOIN users ON videos.user_id = users.id WHERE user_id = '{$_GET['id']}'");   	
			...
			<div class="col-2 bg-white">
				<div class="row  mb-3 ml-2 box">
					...
					<div class="col-8 py-2 px-0" >
						<a href="home.php?id=<?php echo $stroka['id'] ?>"><h5 >Главная</h5></a>
					</div>
				</div>
				<div class="row  mb-3 ml-2 box">
					<div class="col-2 py-2 text-center">
			...
			<div class="col-10" style="height: 500px">
				...
				<div class="col-4">
					<form action="change.php" method="GET">				
						...
						<button class="form-control btn btn-primary mt-3">Изменить</button>
					</form>	
					<form action="deleteAcc.php" method="GET">
						<input type="" name="email" style="display: none" class="form-control mt-2" value="<?php echo $stroka['id'] ?>">

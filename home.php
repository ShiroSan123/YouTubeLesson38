...
<body>
	<?php 
		...
		$id = $_GET['id'];
		$query = mysqli_query($con, "SELECT * FROM users INNER JOIN videos ON videos.user_id = users.id WHERE users.id = $id");
			...
			<div class="col-2">
				<div class="row">
					...
					<div class="col-2 px-0">
						<!--аккаунт-->
						<a href="account.php?id=<?php echo $stroka1['id'] ?>"><img src="img/7.jpg" alt="" class="w-100"></a> 
					</div>
				</div>
			</div>
		</div>
